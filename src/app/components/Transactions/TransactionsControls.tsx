...
export default function TransactionsControl({ type, sort, setSort, filter, setFilter }: TransactionsControlProps): JSX.Element {
  ...
  switch (type) {
    case "invoice": 
      return (
        <div 
          className="transactions__control transactions__invoice" 
    ...
    case "filter": 
      return (
        <div 
          className="transactions__control transactions__filter" 
    ...
    case "sort": 
      return (
        <div 
          className="transactions__control transactions__sort" 
          onClick={ handleSort }
        > <FaSort/>
        </div>
      ) 
